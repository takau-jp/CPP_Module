...
/*   Updated: 2026/04/14 19:48:11 by stanaka2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	{
// 		std::cout << "==================== Tom ====================" <<
// std::endl; 		DiamondTrap Tom; 		Tom = DiamondTrap("Tom"); 		std::cout << std::endl;
// 		Tom.attack("Alice");
// 		Tom.attack("Alice");
// 		Tom.attack("Alice");
// 		Tom.whoAmI();
...
// 	{
// 		std::cout << "==================== Bill ====================" <<
// std::endl; 		DiamondTrap Bill(DiamondTrap("Bill")); 		std::cout << std::endl;
// 		Bill.takeDamage(20);
// 		Bill.attack("Alice");
// 		Bill.beRepaired(20);
// 		Bill.attack("Alice");
